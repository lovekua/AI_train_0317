...
menu0 = new Menu("1. 선형회귀모델")//1. 개발목적/언어-선정/요구사항명세/분석 2. 구현도구/라이센스 3. 테스트도구(junit,mockobj)  4. 형상관리도구  5. 빌드도구
menu0.url = "?menu=0"
menu0.tips = ["1.1 보스톤 주택 가격 현황"]
menu1 = new Menu("2. 공통모듈 구현")
menu1.url = "?menu=1"
menu1.tips = ["2.켈리포니아 주택 가격 현황"] //로그인 로그아웃 기능
